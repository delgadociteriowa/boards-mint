...
const Footer: React.FC = () => (
  <footer className="bg-stone-800 text-stone-300">
    <nav className="w-[90%] mx-auto max-w-[1200px] py-14 flex flex-col gap-8 items-center md:flex-row">
      ...
      <Link href="/soon" className="no-underline hover:text-stone-100 text-xl font-thin lowercase tracking-[3px]">games</Link>
      <Link href="/soon" className="no-underline hover:text-stone-100 text-xl font-thin lowercase tracking-[3px]">about</Link>
