...
const HomeMessageSection: React.FC = () => (
  <section className="py-14 px-10 bg-stone-200 text-stone-600">
    ...
    <Link href="/soon" className="block w-[15rem] bg-stone-100 hover:bg-stone-50 py-6 rounded-full text-center no-underline text-stone-800 text-xl lowercase tracking-[3px] mx-auto my-0 shadow-lg">about</Link>
  </section>
);
