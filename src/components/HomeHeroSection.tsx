  ...
  return (
    <header>
      ...
      <section className='w-[90%] mx-auto max-w-[1200px] h-[85%] py-16 text-stone-200 bg-stone-900 bg-hero-chess bg-center bg-cover rounded-3xl flex flex-col gap-2 shadow-xl/30 appear__main__element'>
        <h1 className='text-5xl text-center font-brand font-thin tracking-[2px]'>
          BOARDS
        </h1>
        ...
        <h2 className='text-center text-xl w-[80%] my-0 mx-auto mb-4'>
          Classic board games. Anywhere, anytime.
        </h2>
        <div className='flex flex-wrap justify-center gap-4 w-[100%]'>
          <Link
            href='/games'
            className='block w-[10rem] shrink bg-stone-200/70 hover:bg-stone-200/90 py-3 rounded-full text-center no-underline text-stone-800 text-xl lowercase tracking-[3px]'
          >
            Play Now
          </Link>
          <Link
