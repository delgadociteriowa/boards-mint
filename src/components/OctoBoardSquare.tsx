...
const OctoBoardSquare = ({cell, squareStyle, onClickPiece, phaseTwo} : OctoBoardSquareProps) => {
  ...
  return (
    <div
      ...
      onClick={() => !phaseTwo ? (cell.piece && onClickPiece(cell.id)) : onClickPiece(cell.id)}>
      {
