      ...
      <Header/>
        <main className="h-[750px]">
          <section className="mx-auto max-w-[1200px] flex flex-wrap mb-10 mt-4">
            ...
            <p className="text-left text-stone-600 leading-relaxed w-[100%] mt-4 mx-6">When registering through a Google account, the platform collects only basic information, personal data that the user has chosen to make publicly available through their Google profile. This information is used solely for the purpose of creating, authenticating, and managing the user’s account within the platform. Users have the right to and can delete their account at any time. Upon deletion, the account and all personal data associated with the account will be permanently removed from the database.</p>
