      ...
      <Header/>
        <main>
          ...
          <section className="mx-auto max-w-[1200px] flex flex-wrap mb-10 mt-4">
            <div className="bg-teal-400 mx-5 px-14 py-16 rounded-3xl shadow-xl/30 my-10 w-[700px] grow">
            ...
            <div className="bg-violet-400 mx-5 px-14 py-16 rounded-3xl shadow-xl/30 my-10 w-[700px] grow">
