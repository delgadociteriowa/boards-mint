      ...
      <Header/>
        <main className="h-[800px]">
          <section className="py-10 px-10 text-stone-600">
            ...
            <a href="/" className="block w-[15rem] bg-stone-300 hover:bg-stone-200 py-6 rounded-full text-center no-underline text-stone-800 text-xl lowercase tracking-[3px] mx-auto my-0 shadow-lg">Home</a>
          </section>
        </main>
      <Footer/>
    </>
